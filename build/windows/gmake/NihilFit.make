...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/NihilFitd.exe
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/nuklear -I../../../include
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/NihilFitp.exe
...
$(OBJDIR)/NihilFit.o: ../../../src/NihilFit.cpp
	@echo $(notdir $<)
